...
urlpatterns = [
    ...
    path('basicmoves/', BasicMoveView, name='basicmove'),
    path('advancedimprovements/', AdvancedImprovementsView , name='advancedimprovement'),
    path('agencygoals', AgencyGoalsView, 'agencygoal'),
    path('agencies', AgencyView, 'agency'),
    path('backgrounds', BackgroundView, 'background'),
    path('chosenbusinessends', ChosenBusinessEndView, 'chosenbusinessend'),
    path('chosenforms', ChosenFormView, 'chosenform'),
    path('chosenmaterials', ChosenMaterialView, 'chosenmaterial'),
